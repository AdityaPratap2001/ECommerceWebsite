  ...
  componentDidMount(){
    ...
    if(this.state.subcategory){
      // axios.get(`http://fcf486b8eac1.ngrok.io/api/products/productCategory/${mainSearchCategory}/ProductSubCategory/${subSearchCategory}`)
        axios.get(`http://4876e7ab8c9d.ngrok.io/api/products/productCategory/productSubCategory/${mainSearchCategory}/${subSearchCategory}`)
        .then(res => {
          console.log(res);
        ...
        axios.get(`http://4876e7ab8c9d.ngrok.io/api/products/productCategory/${mainSearchCategory}`)
        .then(response => {
